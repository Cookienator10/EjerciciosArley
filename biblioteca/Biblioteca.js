...
// Se pregunta al usuario si es devolución o pérdida
let opcion = prompt("¿Es devolución o pérdida?");

// Se le pide al usuario la cantidad de días de retraso
let diasRetraso = parseInt(prompt("Ingrese la cantidad de días de retraso:"));

// Se le pide al usuario la cantidad de libros prestados o revistas
let cantidadLibros = parseInt(prompt("Ingrese la cantidad de libros prestados:"));
let cantidadRevistas = parseInt(prompt("Ingrese la cantidad de revistas prestadas:"));

// Cálculo de multas
let multaLibros = cantidadLibros * 600 * diasRetraso;
let multaRevistas = cantidadRevistas * 500 * diasRetraso;

// Si es pérdida, se agrega una multa adicional
if (opcion === "pérdida") {
  let multaPerdida = (cantidadLibros + cantidadRevistas) * 1000;
  multaLibros += multaPerdida;
}

// Se muestra el resultado de las multas
